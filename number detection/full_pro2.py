...
class fullPro(object):
    ...
    def _list_callback(self,list_analyzed):
        ...
        if done == True:
            ...
            analyzed_parts  = [['1','bolt1','bolt','6'],['1','bearing1','bearing','7'],['1','bearing2','bearing','6'],['1','bolt1','nut','7']
            ,['1','bearing3','bearing','9'],['1','bolt1','nut','9'],['1','bolt1','bolt','6'],['1','bolt1','bearing','6'],['1','bolt1','nut','6'],['1','bolt1','bolt','7'],['1','bolt1','bearing','8'],['1','bolt1','nut','8'],['1','bolt1','gear','8'],['1','bolt1','gear','8'],['1','bolt1','bearing','7'],['1','bolt1','bolt','9'],['1','bolt1','gear','9']]
             #[inner_string.split(', ') for inner_string in list_analyzed.data.split('\n')]
            ...
            for sublist in self.available_analyzed_parts:
                ...
                if result != None:
                    ...
                    if name == 'gear':
                        ...
                        part_position.pose.position.z+=0.006
                        self.value = '1'
                    elif name == 'nut' :
                        self.referred_link = 'tool0_magnetic_tip'
                        part_position.pose.position.z+=0.005
 
                    elif name == 'bearing':
                        self.referred_link = 'tool0_magnetic_tip'
                        part_position.pose.position.z+=0.001
                    ...
                    if self.referred_link == 'tool0_gripper_outer' or 'tool0_magnetic_tip':
                        self.move_group.set_joint_value_target([dr(62),dr(76),dr(-40),dr(0),dr(54),dr(62)])
                        success = False
                        while not success:
                        	success = self.move_group.go(wait=True)
                        self.move_group.stop()
                        self.move_group.clear_pose_targets()
                        rospy.sleep(3)
                        if self.referred_link == 'tool0_gripper_outer':                              
                        	self.proxy(signal='valve',value=self.value)
                        
                    
                    elif self.referred_link == 'tool0_gripper_inner':
                        self.move_group.set_joint_value_target([dr(84),dr(93),dr(-32),dr(30),dr(-66),dr(-17)])
                        success = False
                        while not success:
                        	success = self.move_group.go(wait=True)
                        self.move_group.stop()
